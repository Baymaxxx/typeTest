        ...
        if (typeof c == "object" && !c.length) {
            ...
            return this.each(function () {
                ...
                if (e.is(":visible") && (typeof b.copy == "string" || a.isFunction(b.copy))) {
                    zero_clipboard.setMoviePath(b.path);
                    var d = new zero_clipboard.Client();
...
var zero_clipboard = {
    version: "1.0.7", clients: {}, moviePath: "zero_clipboard.swf", nextId: 1, $: function (a) {
        if (typeof(a) == "string") {
        ...
        var d = jQuery(b);
        var c = d.offset();
        var a = {left: c.left, top: c.top, width: d.width(), height: d.height()};
        return a
    }, Client: function (a) {
        this.handlers = {};
        this.id = zero_clipboard.nextId++;
        this.movieId = "zero_clipboardMovie_" + this.id;
        zero_clipboard.register(this.id, this);
        if (a) {
            this.glue(a)
        }
    }
};
zero_clipboard.Client.prototype = {
    id: 0,
    ready: false,
    movie: null,
    clipText: "",
    ...
    handlers: null,
    glue: function (d, b, e) {
        this.domElement = zero_clipboard.$(d);
        var f = 99;
        ...
        var c = zero_clipboard.getDOMObjectPosition(this.domElement);
    ...
    getHTML: function (d, a) {
        ...
        if (navigator.userAgent.match(/MSIE/)) {
            ...
            c += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="' + e + 'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="' + d + '" height="' + a + '" id="' + this.movieId + '" align="middle"><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="false" /><param name="movie" value="' + zero_clipboard.moviePath + '" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#ffffff" /><param name="flashvars" value="' + b + '"/><param name="wmode" value="transparent"/></object>'
        } else {
            c += '<embed id="' + this.movieId + '" src="' + zero_clipboard.moviePath + '" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="' + d + '" height="' + a + '" name="' + this.movieId + '" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="' + b + '" wmode="transparent" />'
        }
        return c
    },
    hide: function () {
    ...
    reposition: function (c) {
        if (c) {
            this.domElement = zero_clipboard.$(c);
            if (!this.domElement) {
                this.hide()
            }
        }
        if (this.domElement && this.div) {
            var b = zero_clipboard.getDOMObjectPosition(this.domElement);
            var a = this.div.style;
            a.left = "" + b.left + "px";
            a.top = "" + b.top + "px"
        }
